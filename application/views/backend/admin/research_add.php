    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel">
                ...
                <!--Form for Accountant-->
                <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin/research/add" method="post" id="demo-bv-bsc-tabs" target="_top"  enctype="multipart/form-data">
                    <div class="panel-body">
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                placeholder="Resarch Name" name="name">
                            </div>
                          </div>
